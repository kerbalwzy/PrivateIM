...
- #### HTTP-API Functions  <span id="0"> </span>
  ...
  | [GetFriends](#9) | GET    | /relation/friends | 1             | 获取好友列表                   |
  | [GetFriend](#10)  | GET    | /relation/friend  | 1             | 获取单个好友信息               |
  | [AddFriend](#11) | POST   | /relation/friend  | 1             | 添加好友                       |
  | [PutFriend](#12) | PUT    | /relation/friend  | 1             | 修改好友备注; 加入、移出黑名单 |
  | [DelFriend](13) | DELETE | /relation/friend  | 1             | 删除好友                       |
